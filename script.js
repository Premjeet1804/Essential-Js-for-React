...
// }.The book has ${hasMovieAdaptation ? "" : "not"} been adapted for movie } `;
// //summary;

// //Ternary Operators---------------------------------------------

// const result = pages > 1000 ? "over a thousand" : "'less than 1 thousand";
// //result;
...
// console.log(getTotalRevieewCount(book));
